...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    $modules[$i]['config']  = array(
		...
		array('name' => 'merchantAcctId',    'desc'=>'块钱帐户',       'type' => 'text',   'value' => '1002174366204'),
		array('name' => 'payType',    'desc'=>'支付方式',       'type' => 'text',   'value' => '42'),
		array('name' => 'bossType',    'desc'=>'充值卡类型',       'type' => 'text',   'value' => '3'),
		array('name' => 'key',    'desc'=>'设置神州行网关密钥',       'type' => 'text',   'value' => 'XZIYC989HJCKHJS5'),		
