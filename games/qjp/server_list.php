...
//推荐服务器
	$gid=1;
	$memberid=0;
	$sqlstr="select server_gid,server_id,server_name,server_isnew,server_ishot from ".DB_PREFIX."server where server_gid = $gid and server_status = 1 order by server_time desc";
