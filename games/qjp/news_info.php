...
$info_gid = 1;
//新闻资讯
$sqlstr="select cate_id,info_id,subtitle,title,source,content,add_time from ".DB_PREFIX."info where info_start<=".time()." and info_id=$_REQUEST[id] and info_gid={$info_gid}";
