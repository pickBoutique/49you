...
function set_data(){
	var shtml = '';
	if(xlcount<=0){
		shtml +='<table width="100%" height="100%"><tr><td align="center" valign="middle">暂无相关内容，建议登录49you江湖令官网<br>查询更多资料：<a href="http://jhl.49you.com/" style="text-decoration: underline;" target="_blank">jhl.49you.com</a></td></tr></table>';
		$("#xldata").html(shtml);
		return;
	}
