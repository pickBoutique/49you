        ...
        this.initBox = function() {
            ...
            switch(self.options.type) {
                ...
                html =  '<div class="udialog">' +
                        ...
                        '                    <input type="button" class="dialog-ok btn-ok" value="确定">' +
                        '                    <input type="button" class="dialog-cancel btn-cancel" value="取消">' +
                        '                </div>' +
                        '            </td>' +
                    ...
                    type: "GET",
                      ...
                      success: function(data){
                        ...
                        if (data === null) {
                            ...
                            var ovals = jQuery.trim(jQuery(self.options.select.vele).val()).split(',');//原值
