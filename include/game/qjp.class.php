...
class Game_qjp
{
    ...
    function get_login_url($server_info, $user_info)
    {
		...
		$parameter = array(
            ...
            'uname'         => $user_info['member_gamename'],
		...
		/*return For example		http://user.qjp.yaowan.com/User/unitelogin?uid=2470177&uname=lilizizi&lgtime=20110603145016&uip=58.62.166.217&type=yaowan&sid=95901&sign=191ca5dcb1e5cde2c9c1817d020bbd4e
		*/
        return $returl;
    }
    ...
    function to_pay($server_info, $user_info, $order_info)
    {
		...
		$log['url'] = $returl;
		$log['return'] = $ret;
		log_save('游戏充值接口日志_千军破','game_pay_qjp',$log);
		if($ret->status == '400'){
			return true;
		}
        return false;
