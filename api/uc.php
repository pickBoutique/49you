...
define('TABLE_USER', 'online_member'); //用户表名
define('USER_ID', 'member_id'); //用户自增长编号字段名
define('USER_EMAIL', 'email'); //用户邮箱字段名
define('USER_NAME', 'member_name'); //用户名字段名
define('USER_PWD', 'member_pwd'); //用户密码字段名
