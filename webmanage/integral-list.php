<?php
define('PERMI_CODE','integral_list_msg');
...
if($act == 'dataget'){
	...
	$rs = $db->getdata("SELECT * FROM ".DB_PREFIX."integral a  WHERE 1 $where ", &$pager);
	...
	$page_nav = "会员管理 >> 积分获取历史";
	include_once("templates/integral-list.html");
}
