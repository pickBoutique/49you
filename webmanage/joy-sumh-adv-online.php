...
function sumtotal($sumdatetime){
	global $db_admin,$db_salve,$config;
...
from member_login
where ml_startime >= $sumdatetime and ml_startime < $sumhn
group by sd_advid";
...
right join ".$tmptable."
on a.sd_sumtime=b.sd_sumtime and a.sd_advid = b.sd_advid and a.sd_platform = b.sd_platform
...
and c.sd_platform = b.sd_platform)";
	...
	//###################### 汇总online_sumh_server_online表结束 ######################
