...
,a.trans_mname 
,sum(a.trans_money) trans_money 
from ".DB_PREFIX."trans a 
inner join ".DB_PREFIX."member_ref b on a.trans_mname = b.ref_membername and b.ref_addtime >= {$sumdatetime} and b.ref_addtime< {$sumhn}
where 1 and a.trans_instatus = 1 
group by ref_refmd5,trans_mname) t 
