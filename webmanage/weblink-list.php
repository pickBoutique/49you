...
if($act == 'dataget'){
	...
	$rs = $db->getdata("SELECT * FROM ".DB_PREFIX."weblink a left join ".DB_PREFIX."kfbgame b on a.wl_gid=b.fg_id where 1 $where ", &$pager);
	...
	$page_nav = "网页游戏开服管理 >> 网游开服列表";
	include_once("templates/weblink-list.html");
