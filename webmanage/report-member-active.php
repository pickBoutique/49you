<?php
define('PERMI_CODE','report_member_active_msg');
...
//	exit();
	...
	$totalrow=array("adv_name"=> "合计","onlogin"=>0,"5min"=>0,"10min"=>0,"15min"=>0,"20min"=>0,"25min"=>0,"30min"=>0);
	if($rs){
		foreach($rs as $k=>$v){
	...
	include_once("templates/report-member-active.html");
}
