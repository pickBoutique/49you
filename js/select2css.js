...
function rSelects() {
 for (i=0;i<selects.length;i++){
  ...
  select_ul_ul = document.createElement('ul'); 
   select_ul_ul.id = 'options_' + selects[i].name + '_ul';
   select_ul_ul.className = '';
   select_ul_ul.style.position='';
   select_ul_ul.style.display='';
   select_ul_ul.style.zIndex='';
   select_ul_ul.style.width='81px';
   select_ul_ul.style.height='300px';
   select_ul_ul.style.overflowX='hidden';
   select_ul_ul.style.overflowY='scroll';

  select_ul.appendChild(select_ul_ul);
...
function rOptions(i, name) {
 ...
 var options_ul = 'options_' + name + '_ul';
...
window.onload = function(e) {
 ...
 selects = new Array();
 selects[0] = document.getElementById('domain_name49');
 if(selects[0]){
	 rSelects();
